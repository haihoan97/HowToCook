...
public class PostStepUriAdapter extends RecyclerView.Adapter<PostStepUriAdapter.ViewHolder>{
    ArrayList<PostStep> list;
    private Context context;

    public PostStepUriAdapter(ArrayList<PostStep> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (listImg != null){
            ImagePagerUriAdapter imagePagerAdapter = new ImagePagerUriAdapter(listImg, context, ImageView.ScaleType.CENTER_CROP );
        ...
        viewHolder.post_step_step.setText("Buoc "+i);
